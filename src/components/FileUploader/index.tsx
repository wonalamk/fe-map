...
const errorMappings: ErrorMapping = {
  wrongExtension: {
    ...
    errorJSX: (
      <div>
        Wrong file extension. Following file extensions are accepted:{" "}
        <b>{ALLOWED_TILE_EXTENSIONS.join(", ")}</b>
      </div>
    ),
  },
  badFileContent: {
  ...
  return (
    <div className="container">
      ...
      <div className="messages">
        {isFileAccepted && file && fileFromParent && !isFileRejected ? (
          <div>
            Succesfully uploaded <b>{file.name}</b> file
          </div>
        ) : null}
